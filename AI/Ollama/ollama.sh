#!/bin/sh
# This script installs Ollama on FreeBSD.
# This script is distributed as an experimental educational non-commercial project!
...
[ "$(uname -s)" = "FreeBSD" ] || error 'This script is intended to run on Linux only.'
